...
export const Home = () => {
    ...
    let ctx = gsap.context(() => {
      ...
      tl.from(badgeRef.current, { y: 20, opacity: 0, duration: 0.8 })
        ...
        .from(
          ...
          { x: 50, opacity: 0, duration: 1, scale: 0.95 },
          "-=0.8",
        );
  ...
  return (
    <main ref={mainRef} className="min-h-screen bg-white pb-20 overflow-hidden">
      ...
      <section
        ref={heroRef}
        className="relative pt-16 pb-24 px-6 bg-white overflow-hidden"
      >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="text-left">
              <div ref={badgeRef}>
                <Badge
                  variant="secondary"
                  className="mb-8 px-5 py-2 text-sm font-bold text-primary-700 bg-primary-50 border-primary-100 hover:bg-primary-100 transition-colors shadow-sm rounded-full inline-flex items-center gap-2"
                >
              ...
              >
                Smart Shopping <br />
                <span className="text-transparent bg-clip-text bg-linear-to-r from-primary-600 via-indigo-600 to-violet-700">
                  Refined.
                </span>
              </h1>
              ...
              <p
                ref={descriptionRef}
                className="text-xl text-slate-500 max-w-lg mb-12 leading-relaxed font-semibold"
              >
                Buzdealz tracks thousands of exclusive discounts across premium
                brands so you never overpay again.
              </p>
            </div>

            <div className="hero-image-container relative">
              <div className="absolute -inset-4 bg-linear-to-tr from-primary-500 to-violet-500 opacity-10 blur-3xl rounded-[3rem]" />
      ...
      <section className="py-24 px-6">
        <div className="container mx-auto max-w-6xl">
          <div className="relative bg-slate-900 rounded-[3rem] p-12 md:p-20 overflow-hidden shadow-2xl">
            <div className="absolute top-0 right-0 w-1/2 h-full bg-linear-to-l from-primary-600/20 to-transparent blur-3xl pointer-events-none" />
            <div className="relative z-10 text-center max-w-2xl mx-auto">
              ...
              <p className="text-xl text-slate-400 mb-10 font-bold">
                Join 50,000+ smart shoppers receiving our daily curated drops.
              </p>
