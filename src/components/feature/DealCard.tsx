  ...
  return (
    <div className={cn("h-full group/card transition-all duration-300", isExpired && "opacity-75 grayscale-[0.5]")}>
      <Link href={`/deal/${deal.id}`}>
        <Card className="h-full overflow-hidden flex flex-col relative border-slate-100 bg-white shadow-sm hover:shadow-xl hover:shadow-primary-500/10 transition-all duration-500 rounded-2xl border-2 hover:border-primary-100 cursor-pointer">
